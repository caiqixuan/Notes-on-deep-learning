...
"""
具体的调用如下，
use_larger_weights是是否使用较大scale的权重初始化
learning_rate是学习率
activation_fn是选择激活函数
training_batches: 训练阶段使用的batch数（默认为50000）
batches_per_validate_data: 训练多少个batch后在validation数据上进行测试
"""
